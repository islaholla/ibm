...
const About = () => (
  <section id="about" className={`${styles.flexCenter} ${styles.marginY} ${styles.padding} sm:flex-row flex-col bg-black-gradient-2 rounded-[20px] box-shadow`}>
    <div className="flex-1 flex flex-col">
      <h2 className={styles.heading2}> Tentang</h2>
      ...
      <p className={`${styles.paragraph} mt-5`}>Mengakui pentingnya critical workload ini, para IT Leader  harus secara proaktif mengadopsi teknologi terbaru yang meningkatkan ketahanan, skalabilitas, dan keamanan infrastruktur mereka.      </p>
    </div>
  </section>
);
